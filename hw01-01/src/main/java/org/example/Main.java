...
public class Main {
    public static void main(String[] args) {
        ...
        milkFermented.addCategory(new Product("Kefir", 45, 65, 2));
        ...
        bakery.addCategory(new Product("Bulka", 15, 45, 82));
